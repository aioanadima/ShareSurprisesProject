...
class FortuneCookie implements ISurprise {
	...
	private String chosenSaying;

	public FortuneCookie(String message) {
   		this.chosenSaying = message;
	}

	@Override
	public void enjoy() {
		System.out.println("You got a fortune cookie!");
		System.out.println("\"" + this.chosenSaying + "\"");
	}

	@Override
	public String toString() {
		return "[FortuneCookie] message = " + this.chosenSaying;
	}

	public static FortuneCookie generate() {
		int randomSayingIndex = randomGenerator.nextInt(FortuneCookie.quotes.length);
		return new FortuneCookie(FortuneCookie.quotes[randomSayingIndex]);
	}
}