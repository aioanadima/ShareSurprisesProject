...
//    Map<String, Integer> myMap = new HashMap<String, Integer>();
//    myMap.put("FortuneCookieV2", FORTUNE_COOKIE);
...
//
//  static FortuneCookieV2 createFortuneCookie(String[] params, int index) {
//    int qIndex = Integer.parseInt(params[index]);
//    FortuneCookieV2 fc = new FortuneCookieV2(quotes[qIndex % quotes.length]);
//    return fc;
//  }
//
...
//            case FORTUNE_COOKIE:
//              FortuneCookieV2 fc = createFortuneCookie(params, ++i);
